...
import com.test.security.authorize.AuthorizeConfigurerManager;
import com.test.security.file.ImageCodeValidateFilter;
import com.test.security.mobile.MobileAuthenticationConfig;
import com.test.security.mobile.MobileValidateFilter;
import com.test.security.service.impl.CustomUserDetailsService;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    /***
     * 实现权限配置和不需要登录就可以访问的地址这些配置都可以在这个类里面配置，但是为了清洗，都拆分出去了。
     */
    @Autowired
