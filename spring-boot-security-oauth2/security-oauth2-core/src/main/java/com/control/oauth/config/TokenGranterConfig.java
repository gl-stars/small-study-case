...
import com.control.oauth.granter.SMSCodeTokenGranter;
...
public class TokenGranterConfig {
    ...
    private List<TokenGranter> getAllTokenGranters() {
        ...
        if (authenticationManager != null) {
            ...
            // 短信模式(手机号 + 短信验证码)
            tokenGranters.add(new SMSCodeTokenGranter(userDetailsService, validateCodeService, tokenServices, clientDetailsService,requestFactory));
        }
