...
public class StringUtil extends org.apache.commons.lang3.StringUtils{
     ...
     * 根据两个经度和维度计算距离
     * <p>
     *     附加一个测试数据：distanceCalculation(30.535275, 114.352175,30.5352806, 114.3521917)
     * </p>
     * @param lat1 经度（第一个位置）
     * @param lng1 维度（第一个位置）
     * @param lat2 经度（第二个位置）
     ...
     * @return 两地之间的距离 （米）
     */
    public static double distanceCalculation(double lat1, double lng1, double lat2, double lng2){
