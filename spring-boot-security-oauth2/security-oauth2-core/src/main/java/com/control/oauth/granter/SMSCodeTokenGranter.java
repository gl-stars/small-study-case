package com.control.oauth.granter;

import com.control.oauth.service.IValidateCodeService;
...
public class SMSCodeTokenGranter extends AbstractTokenGranter {
    ...
    public SMSCodeTokenGranter(UserDetailsService userDetailsService, IValidateCodeService validateCodeService,
    ...
    protected SMSCodeTokenGranter(UserDetailsService userDetailsService, IValidateCodeService validateCodeService,
                                  AuthorizationServerTokenServices tokenServices, ClientDetailsService clientDetailsService,
